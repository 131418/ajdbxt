...
//							str += '</td>';
							...
							$('#breakCase_modification').on(
									...
									function() {
										...
										$.post('/ajdbxt/info/Info_getPolices', function(Case_data) {
											// 所有案件循环
											var option = '';
...
//												}
											...
											this_modal.find('select[name="info.info_main_police"]').html(option).selectpicker(
													'refresh');
											// 除去加载提示
											this_modal.find('.load_remind').remove();
										}, 'json');
