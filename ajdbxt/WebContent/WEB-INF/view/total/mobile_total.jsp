...
<body>
				...
				<div class="mui-card-header">
					<div>
						...
						<span id="select_case_department"></span> <span
							...
							style="font-size: 14px;">按平均分统计</span>
	...
	<script type="text/javascript">
		...
		$(".input_date").bind("change", function() {
			List_Total_User(averageScore, 1);
		});
		$("#input_PoliceSearchText").bind("input", function() {
			List_Total_User(averageScore, 1);
		});
										...
										function(event) {
											userPicker
													.show(function(items) {
														...
														var averageScore = document
																.getElementById("averageScore").innerHTML;
														List_Total_User(
																averageScore, 1);
