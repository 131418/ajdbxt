...
public class ajdbxt_process {
	...
	public String getProcess_treatment_category() {
		return process_treatment_category;
	}
	public void setProcess_treatment_category(String process_treatment_category) {
		this.process_treatment_category = process_treatment_category;
	}
	...
	public void setProcess_accpet_right(String process_accpet_right) {
		this.process_accpet_right = process_accpet_right;
	}
	public String getProcess_question() {
	...
	public String toString() {
		return "ajdbxt_process [ajdbxt_process_id=" + ajdbxt_process_id + ", process_case_id=" + process_case_id
				...
				+ process_gmt_modify + ", process_question_list=" + process_question_list + ", process_subpoena="
				+ process_subpoena + ", process_criminal_detention=" + process_criminal_detention + ", process_arrest="
				+ process_arrest + ", process_get_keep_wait_interrogate=" + process_get_keep_wait_interrogate
